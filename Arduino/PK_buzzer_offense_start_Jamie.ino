/*
  ...
  MODIFICATIONS:
    ...
    7/13 Jamie Warren
    put listening code in a function
*/
...
int haveWeHeardIt = 0;            // store if we've heard the sound yet
...
// Begin section to detect sound
while (haveWeHeardIt ==0){
  Serial.print("listening");
  haveWeHeardIt = listenForBuzzer();
}    


// End section to detect sound
...
else {Serial.print("Waiting toM shoot...");}
